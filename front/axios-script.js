...
async function getDataSet(category){
	...
	const dataSet = await axios({
        ...
        url: `http://52.78.61.123:3000/Restaurants?category=${qs}`,
...
function getContent(data){
	...
	<div class="infowindow">
        ...
        <div class="infowindow-body">
            ...
            <a href = "${data.videoUrl}" class="infowindow_btn" target="_blank">영상이동</a> 
        </div>
    </div>
	`;
}
...
async function categoryHandler(event){
	...
	try{
		//데이터 분류
		let categoryzedDataSet = await getDataSet(category);
